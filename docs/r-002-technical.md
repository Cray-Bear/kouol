...
博客中的链接指向：
- **博客内部页面** — 需求文档、开发日志等（用博客主题渲染）
- **GitHub 源文件** — 仓库目录、原始文件（作为参考）
...
[📖 需求文档](r-002-requirement.html) · [📖 开发日志](r-002-log.html) · [📂 源文件](https://github.com/Cray-Bear/kouol/tree/main/doc/requirements/R-002)
